    ...
    <section className="py-5">
      <div className="container">
        <div className="text-center mb-4">
          <SectionHeading tag="More Services" title="Explore Our Communication Suite" subtitle="Combine WhatsApp Chatbot with our other channels for a true omnichannel experience." center />
        </div>
