...
export default function Industries() {
  return (
    <section className="py-5" aria-labelledby="voice-industries-heading">
      <div className="container">
        <FadeUp>
          <div className="text-center mb-5">
            <SectionHeading tag="Use Cases" title="Voice Automation for Every Industry" subtitle="From banking to healthcare — automate calls across every sector." center />
          </div>
        </FadeUp>
