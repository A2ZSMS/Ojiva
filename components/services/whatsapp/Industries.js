...
export default function Industries() {
  return (
    <section className="py-5" aria-labelledby="wa-industries-heading">
      <div className="container">
        <FadeUp>
          <div className="text-center mb-5">
            <SectionHeading tag="Use Cases" title="WhatsApp for Every Industry" subtitle="From banking to retail — WhatsApp drives engagement across every sector." center />
          </div>
        </FadeUp>
