...
const SOCIAL = [
  ...
  },
  {
    ...
    label: 'Instagram',
    color: '#e1306c',
    bg: 'linear-gradient(45deg, #feda75, #fa7e1e, #d62976, #962fbf, #c810e4)',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand-col">
            ...
            <div className="footer-social-row">
              {SOCIAL.map(({ href, label, icon, color, bg }) => (
                <a
                  key={label}
                  href={href}
                  ...
                  style={{ '--social-color': color, ...(bg ? { background: bg } : {}) }}
                  title={label}
                >
                  {icon}
                </a>
          ...
          <div className="footer-nav-col">
            ...
            <div className="footer-contact-block">
              ...
              <a className="footer-contact-item" href="mailto:info@ojiva.ai">
                <span className="footer-contact-icon">✉️</span>
                <span>info@ojiva.ai</span>
              </a>
