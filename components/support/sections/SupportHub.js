...
// Support ticket priority string → number (1=highest, 4=lowest)
const SUPPORT_PRIORITY_TO_NUM = { urgent: 1, high: 2, medium: 3, low: 4 };
    ...
    try {
      {
        ...
        fireTeleCRM({
          ...
          priority:    SUPPORT_PRIORITY_TO_NUM[form.priority] ?? 3,
