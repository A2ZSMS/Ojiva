...
/* ── TEST MODE ──────────────────────────────────────────────
 * When true, forms fire ONLY the AiSensy WhatsApp welcome.
 * TeleCRM, Web3Forms and Make.com webhooks are SKIPPED so
 * test submissions don't pollute production data.
 * Keep this at `false` for production. Flip to `true` only
 * to test WhatsApp delivery without spamming CRM/email.
 */
export const TEST_MODE_WHATSAPP_ONLY = false;
...
/* ── WhatsApp — see lib/whatsapp.js ────────────────────────── */
// sendWhatsApp(name, phone) — import from '@/lib/whatsapp'
