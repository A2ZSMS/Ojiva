      ...
      <main className="ty-main">
        <div className="ty-card">
          ...
          <div className="ty-steps">
            {[
              { num: '1', text: 'Check your inbox — a confirmation email is on the way.' },
          ...
          <div className="ty-actions">
            <Link href="/book-demo" className="lp-btn-primary">
              <i className="bi bi-camera-video" /> Book a Full Demo Instead
            </Link>
          ...
          <div className="ty-contact">
            ...
            <a href="tel:+918431086185">
              <i className="bi bi-telephone-fill" /> +91-843-108-6185
            </a>
            <span className="ty-contact-divider">·</span>
